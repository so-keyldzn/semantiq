...
"#;
    ...
    fn test_classify_python_stdlib_comprehensive() {
        ...
        let std_imports = [
            "hashlib", "math", "sqlite3", "http", "xml", "email", "os", "sys", "json",
            "collections", "itertools", "functools", "typing", "dataclasses", "abc", "io",
            "time", "datetime", "logging", "unittest", "argparse", "subprocess", "threading",
            "asyncio", "pathlib", "re", "uuid", "urllib", "csv", "struct", "socket", "ssl",
            "tempfile", "shutil", "glob", "pickle", "enum", "secrets", "statistics",
        ];
